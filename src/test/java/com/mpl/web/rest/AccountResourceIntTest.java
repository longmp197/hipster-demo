package com.mpl.web.rest;

import com.mpl.config.Constants;
import com.mpl.JHipsterJxApp;
import com.mpl.domain.Authority;
import com.mpl.domain.PersistentToken;
import com.mpl.domain.User;
import com.mpl.repository.AuthorityRepository;
import com.mpl.repository.PersistentTokenRepository;
import com.mpl.repository.UserRepository;
import com.mpl.security.AuthoritiesConstants;
import com.mpl.service.MailService;
import com.mpl.service.dto.UserDTO;
import com.mpl.web.rest.errors.ExceptionTranslator;
import com.mpl.web.rest.vm.KeyAndPasswordVM;
import com.mpl.web.rest.vm.ManagedUserVM;
import com.mpl.service.UserService;
...
@SpringBootTest(classes = JHipsterJxApp.class)
